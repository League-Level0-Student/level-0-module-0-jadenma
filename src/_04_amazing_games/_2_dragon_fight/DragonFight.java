...
public class DragonFight {
	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			// or a kick
			String input = JOptionPane.showInputDialog("Do you kick the dragon or yell at it?");
	...
	static void playerLost() {
		...
		// treasure
JOptionPane.showMessageDialog(null, "OOF! You were defeated by the dragon!! You didn't earn any treasure.");
	...
	static void dragonLost() {
		...
		// gold!
JOptionPane.showMessageDialog(null, "HOORAY! You defeated the dragon and won the game!! You earned a lot of gold!");
		System.exit(0); // This code ends the program
	}
